    ...
    return (
        <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50">
            <div className="bg-white rounded p-6 w-80 space-y-3">
                <h2 className="text-center text-base">Eşleşme Bilgisi</h2>

                <input id="d" type="date"  className="w-full border px-2 py-1"/>
                <input id="t" type="time"  className="w-full border px-2 py-1"/>
                <input id="s" type="text"  placeholder="Skor (örn 2-1)" className="w-full border px-2 py-1"/>
                ...
                <button
                    ...
                    onClick={() => {
                        const meta: Meta = {
                            ...
                            winner: Number((document.querySelector('input[name=w]:checked') as HTMLInputElement)?.value)
                        };
                        onSave(meta);
                    }}
                >
                ...
                <button className="w-full py-1 text-sm text-gray-600" onClick={onClose}>
                    İptal
                </button>
            </div>
        </div>
